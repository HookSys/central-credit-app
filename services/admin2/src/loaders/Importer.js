...
import type { TLoader, TImporterLoader, TExcelColumn, TImporterExcelReturn, TImporterTextReturn } from 'types'
...
function Importer(): TLoader<TImporterLoader> {
  ...
  function text(file: File): Promise<TImporterTextReturn> {
    return new Promise<TImporterTextReturn>((resolve) => {
      if (!file) {
