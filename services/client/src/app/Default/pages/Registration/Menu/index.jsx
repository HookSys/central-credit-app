...
const MenuRegistration = ({ entity: { pages } }: TRegistrationPageProps) => {
  return (
    <Fragment>
      <Content>
        ...
        <div className='action-items'>
          ...
          <a
            ...
            href='http://materiais.creditofolha.com/cadastro-de-empresas'
          >
      ...
      <Banner>
        <SvgImage
          icon={AVAILABLE_IMAGES.REGISTRATION_BANNER}
          maxWidth='540px'
          maxHeight='218px'
        />
      </Banner>
