...
export const PAYMENT_LOTS_SELECT_ITEM = 'COMPANY/PAYMENT_LOTS_SELECT_ITEM'
...
export const PAYMENT_LOTS_RESET_RESULTS = 'COMPANY/PAYMENT_LOTS_RESET_RESULTS'
...
export function paymentLotSelectItem(payload) {
  return {
    type: PAYMENT_LOTS_SELECT_ITEM,
    payload,
  }
}

export function paymentLotResetResults() {
  return {
    type: PAYMENT_LOTS_RESET_RESULTS,
  }
}
