...
const CompaniesForm = ({
  ...
  const company = useSelector(({ admin }) =>
    admin.companies.getIn(['options', 'selected'])
  )
    ...
    <Fragment>
      <ColumnWrapper>
        ...
        <ColumnRight isActionBar={true}>
          ...
          <Button
            onClick={() => submit()}
            disabled={invalid || (isEditMode && pristine)}
          >
            Salvar
          </Button>
        </ColumnRight>
